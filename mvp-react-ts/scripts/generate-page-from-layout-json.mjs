...
async function main() {
  ...
  if (String(pageType).toLowerCase() === 'login') {
    ...
    const brandHeaderBar = Boolean(loginTheme.brandHeaderBar)
    const logoSubtitle =
      loginTheme.logoSubtitle != null ? String(loginTheme.logoSubtitle) : '用户登录'
    const logoSubtitleJsExpr = JSON.stringify(logoSubtitle)
    ...
    >
      <section
        ...
        style={{
          ...
          background: '${cardBg}',
          borderRadius: 12,
          padding: ${brandHeaderBar ? "'0'" : "'28px 32px'"},
          overflow: ${brandHeaderBar ? "'hidden'" : "'visible'"},
      ...
      >
        ...
        >
          ...
          >
            {${brandHeaderBar ? logoSubtitleJsExpr : titleJsExpr}}
          </h1>
        </header>
